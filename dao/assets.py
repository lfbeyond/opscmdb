...
class AssetsBase(DataHandle):
    ...
    # def groupList(self):
    #      return Group_Assets.objects.all()
    ...
    def manufacturerList(self):
        try:
            return [ ds.manufacturer  for ds in Assets.objects.raw("""SELECT manufacturer,id from apulis_assets WHERE  manufacturer is not null GROUP BY manufacturer""")]
    ...
    def providerList(self):
        try:
            return [ ds.provider  for ds in Assets.objects.raw("""SELECT provider,id from apulis_assets WHERE  provider is not null GROUP BY provider""")] 
        except Exception as ex:
    ...
    def modelList(self):
        try:
            return [ ds.model  for ds in Assets.objects.raw("""SELECT model,id from apulis_assets WHERE  model is not null GROUP BY model""")]
        except Exception as ex:
    ...
    def cpuList(self):
        try:
            return [ ds.cpu  for ds in Server_Assets.objects.raw("""SELECT cpu,id from apulis_server_assets WHERE  cpu is not null GROUP BY cpu""")]
        except Exception as ex:
    ...
    def systemList(self):
        try:
            return [ ds.system  for ds in Server_Assets.objects.raw("""SELECT system,id from apulis_server_assets WHERE  system is not null GROUP BY system""")]
        except Exception as ex:
    ...
    def kernelList(self):
        try:
            return [ ds.kernel  for ds in Server_Assets.objects.raw("""SELECT kernel,id from apulis_server_assets WHERE  kernel is not null GROUP BY kernel""")]
        except Exception as ex:
